...
1.  **[Project activity](#project-activity)**: **2.03** (weight is 0.5)
...
12 commits in the last 3 months results to 1.85 points
3 contributors increase the score value from 1.85 to 2.03

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **12**
