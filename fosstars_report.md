...
**Score**: **4.69**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **4.23** (weight is 0.5)
...
Score: **6.14**, confidence is 9.52 (high), weight is 1.0 (high)
...
Score: **4.23**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

25 commits in the last 3 months results to 3.85 points
3 contributors increase the score value from 3.85 to 4.23

This sub-score is based on 2 features:

1.  Number of commits in the last three months: **25**
1.  Number of contributors in the last three months: **3**

### Project popularity

Score: **0.02**, confidence is 10.0 (max), weight is 0.5 (medium)
...
1.  Number of stars for a GitHub repository: **6**
...
Score: **3.5**, confidence is 8.0 (low), weight is 1.0 (high)
