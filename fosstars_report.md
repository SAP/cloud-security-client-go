...
**Score**: **3.75**, max score value is 10.0
...
1.  **[Project activity](#project-activity)**: **2.71** (weight is 0.5)
...
Score: **2.71**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

16 commits in the last 3 months results to 2.46 points
3 contributors increase the score value from 2.46 to 2.71
...
Score: **0.03**, confidence is 6.67 (low), weight is 0.5 (medium)
...
1.  **Number of stars for a GitHub repository:** 9
