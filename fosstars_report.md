...
1.  **[Project activity](#project-activity)**: **2.42** (weight is 0.5)
...
Score: **2.42**, confidence is 10.0 (max), weight is 0.5 (medium)

The score evaluates how active a project is. It's based on number of commits and contributors in the last 3 months.

15 commits in the last 3 months results to 2.31 points
2 contributors increase the score value from 2.31 to 2.42
